...
challenge1_lower = challenge1.lower()

if challenge1_lower == "left":
  ...
  challenge2_lower = challenge2.lower()
  
  if challenge2_lower == "wait":
    ...
    challenge3_lower = challenge3.lower()
    
    if challenge3_lower == "yellow":
      print("You found the treasure! You Win!")
    elif challenge3_lower == "blue":
      print("You enter a room of beasts. Game Over.")
    elif challenge3_lower == "red":
